...
%define		src_ver	8u144
%define		bld_ver	b01
%define		dir_ver	%(echo %{version} | sed 's/\\.\\([^.]\\+\\)$/_\\1/')
%define		bhash	090f390dda5b47b9b721c7dfaa008135
