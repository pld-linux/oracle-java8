...
%define		src_ver	8u131
%define		bld_ver	b11
%define		dir_ver	%(echo %{version} | sed 's/\\.\\([^.]\\+\\)$/_\\1/')
%define		bhash	d54c1d3a095b4ff2b6607d096fa80163
