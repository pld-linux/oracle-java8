...
%define		src_ver	8u141
%define		bld_ver	b15
%define		dir_ver	%(echo %{version} | sed 's/\\.\\([^.]\\+\\)$/_\\1/')
%define		bhash	336fa29ff2bb4ef291e347e091f7f4a7
